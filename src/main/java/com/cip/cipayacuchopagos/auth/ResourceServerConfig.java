...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/cipayacucho/**", "/api/seguridad").permitAll()
		.antMatchers(HttpMethod.POST, "/api/cipayacucho/**","/api/cipayacucho/**", "/api/seguridad").permitAll()
